...
const station1: Property['crops'][0]['stations'][0] = {
  ...
  sensorData: {
    ...
    ultravioletIndex: { name: 'Ultravioleta', value: 55000, unit: 'Lux', trend: generateTrend(55000), icon: Sun },
    ...
    precipitation: { name: 'Precipitação', value: 3.2, unit: 'mm/dia', trend: generateTrend(3.2), icon: CloudDrizzle },
...
const station2: Property['crops'][0]['stations'][0] = {
  ...
  sensorData: {
    ...
    ultravioletIndex: { name: 'Ultravioleta', value: 62000, unit: 'Lux', trend: generateTrend(62000), icon: Sun },
    ...
    precipitation: { name: 'Precipitação', value: 4.1, unit: 'mm/dia', trend: generateTrend(4.1), icon: CloudDrizzle },
